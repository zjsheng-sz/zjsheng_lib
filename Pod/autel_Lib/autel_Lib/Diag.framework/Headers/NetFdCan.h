// NetFdCan.h: interface for the CNetFdCan class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_NetFdCan_H__95653791_926C_42AB_BC95_460D6377A361__INCLUDED_)
#define AFX_NetFdCan_H__95653791_926C_42AB_BC95_460D6377A361__INCLUDED_
...
extern bool g_b7F78NegativeResponse; // xiaopei add 2015-07-31 动作测试有用到 7F 78交给否定类处理
...
/******************************************************************************
    ...
    ---------------------------------------------------------------------------
     时     间   作者    版本号   操    作    内    容
    ---------------------------------------------------------------------------
     2007.10.10   纪安荣  1.0      创建此类
     2007.10.10   纪安荣  1.0      编写实现代码

*******************************************************************************/

class CNetFdCan : public CNetLayerBase  
{
...
public:
	...
	/*-----------------------------------------------------------------------------
      ...
      参    数：CSendFrame SendFrame -- 发送帧，
				...
				命令字后为填充字节，NetFdCan取命令字后第一个字节，如果无填充字节，则不需填加
...
#endif // !defined(AFX_NetFdCan_H__95653791_926C_42AB_BC95_460D6377A361__INCLUDED_)
