// NetGMVpw.h: interface for the CNetGMVpw class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_NetGMVpw_H__1AB8BA56_5278_4151_8E19_2B222F2DF088__INCLUDED_)
#define AFX_NetGMVpw_H__1AB8BA56_5278_4151_8E19_2B222F2DF088__INCLUDED_
...
/******************************************************************************
    ...
    ---------------------------------------------------------------------------
     时     间   作者    版本号   操    作    内    容
    ---------------------------------------------------------------------------
     2007.11.06   邓仁祥  1.0      创建此类
     2007.11.06   邓仁祥  1.0      编写实现代码
	 2010.04.27   杨高岐  V0.99.11 添加校验

*******************************************************************************/

class CNetGMVpw : public CNetLayerBase  
{
public:
	CNetGMVpw();
	virtual ~CNetGMVpw();
	...
	CSendFrame PackCS(CSendFrame SendFrame);
	CBinary PackCS(CBinary binCmd);
...
#endif // !defined(AFX_NetGMVpw_H__1AB8BA56_5278_4151_8E19_2B222F2DF088__INCLUDED_)
