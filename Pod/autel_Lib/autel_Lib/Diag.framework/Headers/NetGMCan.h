// NetGMCan.h: interface for the CNetGMCan class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_NetGMCan_H__95653791_926C_42AB_BC95_460D6377A361__INCLUDED_)
#define AFX_NetGMCan_H__95653791_926C_42AB_BC95_460D6377A361__INCLUDED_
...
/******************************************************************************
    ...
    文件名称：NetGMCan.h NetGMCan.cpp

    档 标 识：

    摘    要：本类是所有实现GM CAN(单双线)网络层的功能

    用    法：1、声明初始化：   
                 CNetGMCan NetGMCan;
                 NetGMCan.Init();
              2、完成具体通信：
                 NetGMCan.SendReceive(...);
              3、不再使用，最后消毁
                 NetGMCan.Destroy();
...
class CNetGMCan : public CNetLayerBase  
{
...
public:
	...
	/*-----------------------------------------------------------------------------
      ...
      参    数：CSendFrame SendFrame -- 发送帧，
				...
				命令字后为填充字节，NetGMCan取命令字后第一个字节，如果无填充字节，则不需填加
...
#endif // !defined(AFX_NetGMCan_H__95653791_926C_42AB_BC95_460D6377A361__INCLUDED_)
