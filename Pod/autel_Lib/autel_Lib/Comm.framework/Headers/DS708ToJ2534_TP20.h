...
class CDS708ToJ2534_TP20 : public CDS708ToJ2534Base
{
public:
	CDS708ToJ2534_TP20(void);
	virtual ~CDS708ToJ2534_TP20(void);
	...
	virtual CReceiveFrame SendReceive_EX(CSendFrame SendFrame);
	...
	unsigned int m_uThisReceptionID; // 2015-8-14 增加 02 02 进入方式用到

	bool m_DisconnectFlag;/*tp20可以控制是否断开与ECU的连接*/
};
