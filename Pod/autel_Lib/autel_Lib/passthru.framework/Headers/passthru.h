...
#define  LOG_TAG    "LIB_PASSTHRU"
#define MAXILOG_TAG "LIB_PASSTHRU"

#define MAX_MESSAGE_SIZE    4128

extern char g_ucUsbDevNode[];
...
enum 
{
    ...
    ISO_15765_FLOWCTRL_AUTO = 0x00010000,
    TP1_6_KWP2K,
    NISSAN_CLKPIN,
	ISO15765_PAD,
	UEB_RCV_IDMSGS
...
extern "C"{
    ...
    J_EXPORT_IN_8 PassThru_Get_Factory_Cfg 
        (
        J_EXPORT_U_IN_8 DeviceID,
        J_EXPORT_U_IN_8 net_mod,
        void *pCfg
        );

    J_EXPORT_IN_8 PassThru_Set_Factory_Cfg 
        (
        J_EXPORT_U_IN_8 DeviceID,
        void *pCfg
        );

    J_EXPORT_IN_8 PassThruResetBoard
        (
        J_EXPORT_U_IN_8 DeviceID,
        J_EXPORT_U_IN_8* pDeviceCode
        );
...
#else
    //////////////////////////////////////////////////////////////////////////
    //用不到的 先注释 saej2534_func.h中是没有的
//     int (*add)(int a, int b);
// 
//     typedef long ( *PASSTHRUOPEN)
//     (
//      void *pName,
//      unsigned long *pDeviceID
//      );
// 
//     typedef long ( *PASSTHRUCLOSE)(unsigned long DeviceID);
// 
//     typedef long ( *PTCONNECT)
//     (
...
// 
//     typedef long ( *PTREADMSGS)
//     (
//      unsigned long, PASSTHRU_MSG *, 
//      unsigned long *,
//      unsigned long
//      );
// 
//     typedef long ( *PTWRITEMSGS)
//     (
//      unsigned long,
//      PASSTHRU_MSG *,
//      unsigned long *,
...
//      );
// 
//     typedef long ( *PTSTARTPERIODICMSG)
//     (
//      unsigned long,
//      PASSTHRU_MSG *,
//      unsigned long *,
...
// 
//     typedef long ( *PTSETPROGRAMMINGVOLTAGE)(unsigned long, unsigned long, unsigned long);
// 
...
// 
//     typedef long ( *PTFACTORYRSDSETCFG) 
//     (
//      unsigned long DeviceID,
//      void *pCfg
//      );
// 
//     typedef long ( *PTFACTORYRSDGETCFG) 
//     (
//      unsigned long DeviceID,
//      void *pCfg
//      );
// 
//     typedef long ( *PTLOADDATA)
//     (
//      unsigned long DeviceID,
//      PDATAFILE pstFileData, 
//      unsigned char* pData, 
//      unsigned long* pPackNo
//      );
// 
//     typedef long ( *PTFREADFAULTCODE)
//     (
//      unsigned long DeviceID,
//      unsigned char* pData,
//      unsigned long* pFalutCnts
//      );
#endif
